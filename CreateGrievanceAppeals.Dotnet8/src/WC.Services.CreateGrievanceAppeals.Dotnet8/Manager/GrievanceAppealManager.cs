...
namespace WC.Services.CreateGrievanceAppeals.Dotnet8.Manager
{
    using System;
    using System.Globalization;
    // using CareSource.WC.OnBase.Core.Diagnostics.Interfaces;
    using global::WC.Services.CreateGrievanceAppeals.Dotnet8.Models;
    using global::WC.Services.CreateGrievanceAppeals.Dotnet8.Models.Data;
    ...
    public class GrievanceAppealManager
    {
        ...
        public GrievanceAppealManager(log4net.ILog logger, IConfiguration configuration)
        {
            _logger = logger;
    ...
    //    // const int Grievance_Streamline_Form_ID = //153;//"AG - Grievance Streamline API Form II";
        ...
        {
            int grievanceUtilityFormId = Convert.ToInt32(_configuration["GreivanceAppealsForms:Grievance_Streamline_Form_ID"]);
            int maUtilityUnityFormID = Convert.ToInt32(_configuration["GreivanceAppealsForms:MA_Utility_Unity_Form_ID"]);
            int paplProviderAppealsUnityFormID = Convert.ToInt32(_configuration["GreivanceAppealsForms:PAPL_Provider_Appeals_Submission_Unity_Form_ID"]);
            int paplProviderDisputeUnityFormID = Convert.ToInt32(_configuration["GreivanceAppealsForms:PAPL_Provider_Dispute_Submission_Unity_Form_ID"]);
            ...
            try
            {
                _logger.Info($@"{loggerInit} {"Into GrievanceAppealManager."}");
                    ...
                    grievanceAppealsData.ApplicationName.ToUpper() == "NC") //  Ncentaurus 
                {
                    ...
                    if (grievanceAppealsData.CallType.ToUpper() == "GRIEVANCE")
                    {
                        ...
                        FormTemplate template1 = app.Core.UnityFormTemplates.Find(grievanceUtilityFormId);
                    ...
                    else if (grievanceAppealsData.CallType.ToUpper() == "APPEAL")
                    {
                        ...
                        FormTemplate template1 = app.Core.UnityFormTemplates.Find(maUtilityUnityFormID);
                ...
                else if (grievanceAppealsData.ApplicationName.ToUpper() == "PP") // Provider Portal
                {
                    ...
                    else if (grievanceAppealsData.CallType.ToUpper() == "APPEAL")
                    {
                        ...
                        FormTemplate template1 =
                            app.Core.UnityFormTemplates.Find(paplProviderAppealsUnityFormID);
                    ...
                    else if (grievanceAppealsData.CallType.ToUpper() == "DISPUTE")
                    {
                        ...
                        FormTemplate template1 =
                            app.Core.UnityFormTemplates.Find(paplProviderDisputeUnityFormID);
            ...
            string loggerInit)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(grievanceAppealsData.AdminCat1))
                {
                    ...
                    eFormProps.AddKeyword("Admin Cat 1", grievanceAppealsData.AdminCat1);
                }
                ...
                {
                    DateTime aorExpires;
                    DateTime.TryParseExact(grievanceAppealsData.AORExpires, "yyyy-MM-dd", CultureInfo.InvariantCulture, DateTimeStyles.None, out aorExpires);
                    eFormProps.AddKeyword("AOR Expires", aorExpires); //AOR Expires
                }
                ...
                if (!string.IsNullOrEmpty(grievanceAppealsData.AORRepresentativePhone))
                {
                    eFormProps.AddKeyword(
                        ...
                        Convert.ToInt64(grievanceAppealsData.AORRepresentativePhone));
                }
                ...
                {
                    DateTime.TryParseExact(grievanceAppealsData.DateComplete, "yyyy-MM-dd", CultureInfo.InvariantCulture, DateTimeStyles.None, out DateTime dtComplete);
                    eFormProps.AddKeyword("Date Complete",dtComplete);
                }
                ...
                {
                    DateTime.TryParseExact(grievanceAppealsData.EnrollmentEndDate, "yyyy-MM-dd", CultureInfo.InvariantCulture, DateTimeStyles.None, out DateTime enrollmentEndDate);
                    eFormProps.AddKeyword("Coverage End",enrollmentEndDate);
                }

                if (!string.IsNullOrEmpty(grievanceAppealsData.EnrollmentStartDate))
                {
                    DateTime.TryParseExact(grievanceAppealsData.EnrollmentStartDate, "yyyy-MM-dd", CultureInfo.InvariantCulture, DateTimeStyles.None, out DateTime enrollmentstDate);
                    eFormProps.AddKeyword("Coverage Start",enrollmentstDate);
                    // eFormProps.AddKeyword(
                    //     "Coverage Start",
                ...
                {
                    DateTime.TryParseExact(grievanceAppealsData.InitiationDate, "yyyy-MM-dd", CultureInfo.InvariantCulture, DateTimeStyles.None, out DateTime initiationDate);
                    eFormProps.AddKeyword("Occurrence Date", initiationDate);
                }
                ...
                {
                    DateTime.TryParseExact(grievanceAppealsData.MemberDOB, "yyyy-MM-dd", CultureInfo.InvariantCulture, DateTimeStyles.None, out DateTime memberDOB);
                    eFormProps.AddKeyword( "AC: Patient Date of Birth", memberDOB);
                }
                ...
                {
                    DateTime.TryParseExact(grievanceAppealsData.ReceivedDate, "yyyy-MM-dd", CultureInfo.InvariantCulture, DateTimeStyles.None, out DateTime receivedDate);
                    eFormProps.AddKeyword("Corporate Received Date Time",receivedDate);
                }
            ...
            {
                _logger.Error(loggerInit + "Error: Adding Grievance Keywords: " + ex);
            ...
            string loggerInit)
        {
            ...
            {
                _logger.Error(loggerInit + "Error: Adding Appeal Keywords: " + ex);
            ...
            string loggerInit)
        {
            ...
            {
                _logger.Error(loggerInit + "Error: Adding PP Appeal Keywords: " + ex);
                //return false;
            ...
            string loggerInit)
        {
            ...
            {
                _logger.Error(loggerInit + "Error: Adding PP Dispute Keywords: " + ex);
        ...
        {
            Application app = null;
            AuthenticationProperties sessionAuthProp = Application.CreateOnBaseAuthenticationProperties(connParams.ServerURL, connParams.UserName, connParams.Password, connParams.Datasource);
           
            try
            {
                //app = Application.Connect(domAuthProps);
                app = Application.Connect(sessionAuthProp);
            }
