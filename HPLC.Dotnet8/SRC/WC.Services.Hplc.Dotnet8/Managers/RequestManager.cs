   ...
   // using System.Web.Http.ModelBinding;
    ...
    public class RequestManager : IRequestManager
    {
        ...
        public long CreateRequest(HplcServiceRequest request)
        {
            ...
            request.RequestData.JsonData = System.Text.Json.JsonSerializer.Serialize(request.RequestData);
            ...
            string npi)
        {
            ...
            IEnumerable<Provider> providers = request.Providers.Where(
                p =>
                    !String.IsNullOrWhiteSpace(p.Npi)
                    && p.Npi.Equals(
                        npi,
                        StringComparison.InvariantCultureIgnoreCase)
                    || !String.IsNullOrWhiteSpace(p.GroupNpi)
                    && p.GroupNpi.Equals(
                        npi,
                        StringComparison.InvariantCultureIgnoreCase));
            ...
            ModelStateDictionary modelState)
        {
            ...
            if (!String.IsNullOrWhiteSpace(request.RequestData.HealthPartnerAgreementType))
            {
            ...
            if (!String.IsNullOrWhiteSpace(request.RequestData.Type))
            {
            ...
            ModelStateDictionary modelState)
        {
            ...
            (
                ...
                where !products.Contains(product.Name.Trim())
                select $"[{product.Name.Trim()}] is not a valid Product.").ToList();
