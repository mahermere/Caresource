...
namespace WC.Services.Hplc.Dotnet8.Models
{
    ...
    public static class Constants
    {
        ...
        public static class Request
        {
            ...
            //Additions made to new Fields
            public const string ContractingStatus = "ContractingStatus";
            public const string GroupMedicaidIDMultiLoc = "GroupMedicaidIDMultiLoc";
            public const string GroupNPIMultiLoc = "GroupNPIMultiLoc";
            public const string AssignedCON = "AssignedCON";
            public const string FinalDeleteLink = "FinalDeleteLink";
            public const string InternalViewLink = "InternalViewLink";
            public const string AssignedCONT = "AssignedCONT";
            public const string UserCorrectRejectNotes = "UserCorrectRejectNotes";
            public const string MultiLocations = "MultiLocations";
            public const string MedicaidState = "MedicaidState";
            public const string AtypicalProvider = "AtypicalProvider";
            ...
            public const string State = "State";
            public const string City = "City";
            public const string Street2Address = "Street2Address";
            public const string CommonAddressforReuse = "CommonAddressforReuse";
            public const string UpdateSameAsRemit = "UpdateSameAsRemit";
            public const string MailingSameAsRemit = "MailingSameAsRemit";
            public const string OfcContactCMHCPProv = "OfcContactCMHCPProv";
            public const string OfcContactPhoneExt = "OfcContactPhoneExt";
            public const string NewIRSNameEffDate = "NewIRSNameEffDate";
            public const string PriorIRSName = "PriorIRSName";
            public const string IRSNameChange = "IRSNameChange";
            public const string TaxIDEffDate = "TaxIDEffDate";
            public const string PriorTaxIDNumber = "PriorTaxIDNumber";
            public const string TaxIDChange = "TaxIDChange";
            public const string DBHDDProvider = "DBHDDProvider";
