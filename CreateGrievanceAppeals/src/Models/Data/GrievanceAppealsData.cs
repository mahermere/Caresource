...
namespace CareSource.WC.Services.CreateGrievanceAppeals.Models.Data
{
	...
	public class GrievanceAppealsData
	{
		public List<KeywordValue> AdditionalInput = new List<KeywordValue>();
		...
		public string PreviousAppealorDisputeID { get; set; }
	}
