namespace CareSource.WC.Services.Document.Adapters
{
	...
	public class OnBaseCreateKeywordAdapter : ICreateKeywordAdapter<Keyword>
	{
		...
		public OnBaseCreateKeywordAdapter(IApplicationConnectionAdapter<Application> applicationConnectionAdapter
			, ILogger logger)
		{
		...
		public Keyword CreateKeyword(string value, string keywordTypeName, string defaultKeywordDocumentTypeName, bool blankKeyword)
		{
			...
			var documentTypeList = _applicationConnectionAdapter
				.Application
				.Core
				.DocumentTypes;
